...
export const AddMoneyModal: React.FC<AddMoneyModalProps> = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Route Airtel Money to dedicated integration for proper PIN prompt
      if (paymentMethod === 'airtel_money') {
        ...
        toast({
          ...
          description: `Check ${formattedPhone} for Airtel Money PIN prompt`,
        });
      } else {
        ...
        toast({
          ...
          description: paymentMethod === 'card' 
            ...
            : `Check ${formattedPhone} for M-Pesa PIN prompt`,
        });
      }
