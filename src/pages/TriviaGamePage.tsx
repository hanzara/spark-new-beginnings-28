...
import EnhancedGameplay from '@/components/game/EnhancedGameplay';
...
const TriviaGamePage: React.FC = () => {
  ...
  const handleModeSelect = (modeId: string) => {
    ...
    toast({
      title: "Game Starting! 🎮",
      description: `Get ready for ${modeId.replace('-', ' ')} mode!`,
    });
  };

  const handleGameEnd = (finalScore: number, earnings: number) => {
    setIsInGame(false);
    setSelectedMode(null);
    toast({
      title: "Game Complete! 🎉",
      description: `You scored ${finalScore} points and earned ${earnings} KES!`,
    });
  };

  const handlePowerUpPurchase = (powerUpId: string, quantity: number, cost: number) => {
    setPowerUps(prev => ({
      ...prev,
  ...
  const sampleQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation: "The CBR is Kenya's benchmark interest rate that influences lending rates.",
      difficulty: "medium" as const,
      category: "Finance",
      points: 100
    },
    {
      ...
      correctAnswer: 2,
      explanation: "Financial experts recommend saving 20-30% of your income.",
      difficulty: "easy" as const,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation: "Blue chip stocks are shares in large, well-established, financially sound companies.",
      difficulty: "medium" as const,
          ...
          <>
            ...
            <div className="mb-8 text-center animate-fade-in">
              ...
              <p className="text-slate-300 mt-4 text-lg md:text-xl max-w-2xl mx-auto">
                Test your knowledge, compete globally, and earn real rewards!
              </p>
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 mt-6">
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-600/20 to-emerald-600/20 rounded-full backdrop-blur-sm border border-green-500/30">
                  ...
                  <span className="text-green-300 font-bold">KES {(profile?.balance || 0).toLocaleString()}</span>
                </div>
                {profile?.is_premium && (
            ...
            <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
              {['modes', 'power-ups', 'achievements', 'leaderboard'].map((tab) => (
                <Button
                  key={tab}
                  variant={selectedMode === tab ? "default" : "outline"}
